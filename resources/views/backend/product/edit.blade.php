    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="parent_category" class="col-form-label">Sub Category<span
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control">
                            <option {{ $product->status == '1' ? 'selected' : '' }}>Active</option>
                            <option {{ $product->status == '0' ? 'selected' : '' }}>Inactive</option>
                        </select>
                        @error('status')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
