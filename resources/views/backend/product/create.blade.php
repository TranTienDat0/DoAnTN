    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="parent_category" class="col-form-label">SubCategory<span
                ...
                <div class="form-group">
                    <label for="date_of_manufacture" class="col-form-label">Date Of Manufacture <span
                            class="text-danger">*</span></label>
                    <input id="date_of_manufacture" type="date" name="date_of_manufacture" placeholder="Enter date_of_manufacture"
                ...
                <div class="form-group">
                    <label for="expiry" class="col-form-label">Expiry <span class="text-danger">*</span></label>
                    <input id="expiry" type="date" name="expiry" placeholder="Enter expiry"
